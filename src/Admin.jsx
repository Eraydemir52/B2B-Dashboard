...
const Admin = () => {
  ...
  const [isOpenUrun, setIsOpenUrun] = useState(false); // Formun açı
  const [categories, setCategories] = useState([]); // Kategorileri tutmak için state
  const [isOpenSiparis, setIsOpenSiparis] = useState([]); //
  useEffect(() => {
  ...
  const toggleFormSiparis = () => {
    ...
    setIsOpenSiparis(!isOpenSiparis);
  ...
  return (
    <div>
      ...
      <div className="admin-container">
        ...
        {isOpenUrun && ( // Ürün Formunu göster
          <Urun />
        )}
